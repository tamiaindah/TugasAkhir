    ...
    <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-text mx-3">HANNA FLOWER STORY</div>
            </a>
            ...
            <li class="nav-item {{ Request::is('admin/kategori*') ? ' active' : '' }} {{ Request::is('admin/produk*') ? ' active' : '' }}">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" ariacontrols="collapseTwo">
                    <i class="fa fa-shopping-bag"></i>
                    <span>PRODUK</span>
                </a>
                <div id="collapseTwo" class="collapse {{ Request::is('admin/kategori*') ? ' show' : '' }} {{ Request::is('admin/produk*') ? ' show' : '' }}" arialabelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">KATEGORI & PRODUK</h6>
                        <a class="collapse-item {{ Request::is('admin/kategori*') ? ' active' :'' }}" href="{{ route('admin.kategori.index') }}">KATEGORI</a>
                        <a class="collapse-item {{ Request::is('admin/produk*') ? ' active' : '' }}" href="{{ route('admin.produk.index') }}">PRODUK</a>
                    </div>
                </div>
            </li>
            <div class="sidebar-heading">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Hak Cipta Dilindungi &copy; 2020 Hana Flower Story -
                            hanaflowerstory </span>
                    </div>
                </div>
            </footer>
