...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-5 mb-5">
            <div class="card border-0 shadow">
                <div class="card-header">
                    <h6 class="m-0 font-weight-bold"><i class="fas fakey"></i> TWO-FACTOR AUTHENTICATION</h6>
                </div>
                <div class="card-body">
                    ...
                    @if(session('status') == 'two-factor-authenticationenabled')
        ...
        <div class="col-md-7">
            <div class="card border-0 shadow">
                <div class="card-header">
                    <h6 class="m-0 font-weight-bold"><i class="fas fauser-circle"></i> EDIT PROFILE</h6>
                </div>
                <div class="card-body">
            ...
            <div class="card border-0 shadow mt-3 mb-4">
                <div class="card-header">
                    <h6 class="m-0 font-weight-bold"><i class="fas faunlock"></i> UPDATE PASSWORD</h6>
                </div>
                <div class="card-body">
