    ...
    <div class="row justify-content-center">
        <div class="col-md-4">
            ...
            <div class="card o-hidden border-0 shadow-lg mb-3 mt-5">
               <div class="card-body p-4">  <!-- buat nampilin pesan status dari lupa pass -->
                    @if (session('status'))
                    ...
                    <form method="POST" action="{{ route('password.email') }}">  <!-- buat nampilin form yang di arahin ke password/email -->
                        @csrf
                        <div class="form-group">
                            ...
                            @error('email') <!-- pesan error email nya slah/gabisa nemuin emailnya -->
